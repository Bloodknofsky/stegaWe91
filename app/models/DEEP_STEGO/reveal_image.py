...
def reveal_image(stego_image_filepath):
    model = load_model("D:/Quantum_Physics/499/stegaWe91(capstone)/app/models/DEEP_STEGO/models/reveal.h5", compile=False)
    ...
    imageio.imsave("D:/Quantum_Physics/499/stegaWe91(capstone)/images/secret_out.png", secret_image_out)
